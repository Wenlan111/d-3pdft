...
lgeo1=gto.Mole()
lgeo1.atom= ''' 
O  -2.67161  1.45206  9.38876
O  -1.55784  0.79315  9.38876
'''
lgeo1.unit='angstrom'
...
rgeo2.spin = 2
rgeo2.build()
rdft2 = fragments.FragmentDFT(rgeo2,'pbe',metal = True,smearing =True, newton= False)
...
data = pickle.load(open("pdft_checkpointnewf2.pkl", "rb"))
...
Efold = Ef
nold = nf
checkpoint = "pdft_checkpointnewf3.pkl"
#PDFT-scf-LOOP
start = data["step"] + 1
rdft1.D=data["dm_ig1"]
rdft2.D=data["dm_ig2"]
